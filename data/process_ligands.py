...
class Protein_dataset(InMemoryDataset):
    def __init__(self,
        ...
        self.concat_folder_path = 'data/contact_maps_ligands'

        # Language model embedding folder
        self.emb_folder_path = 'data/embeddings_ligands'
    ...
    def processed_file_names(self):
        return "data_protein_ligands.pt"
    ...
    def process(self):
        ...
        for index, row in self.df.iterrows():
            ...
            sequence = row['Ligand Chains'][:999] if len(row['Ligand Chains']) > 1000 else row['Ligand Chains']
            target_id = row["PDB"]
